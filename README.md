...
<p align="center">
  ...
  Use <code>$awesome-ppt-std</code> for the stable image-first flow, or
  <code>$awesome-ppt-editable</code> for an experimental <code>ppt-master</code> editable reconstruction.
</p>
